          ...
          {!isViewMore ?
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              {SkillTab.map((SkillTab, index) => (
                <SkillBtn BtnWidth="w-[3.5rem] xsm:w-32" key={index} BtnHeight="h-[2rem]" SkillBtnText={SkillTab} textSize="text-[10px] xsm:text-[18px]" BtnColorBack="bg-very-light-violet" BtnColorFront="bg-dark-violet" className="w-48"/>
              ))}
              </div>
              <div className="flex flex-col items-center justify-center mt-[1rem]">
                <a href={LinkProject} target="_blank" without="true" rel="noopener noreferrer" className="text-center text-[12px] xsm:text-[18px] md:text-[24px] text-white pb-[.5rem] hover:underline">Click for my repositories</a>
