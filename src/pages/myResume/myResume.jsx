    ...
    <>
      <div className="bg-dark-blue-violet flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-16 lg:justify-between lg:px-8">
          ...
          <a href="https://linktr.ee/tifenn_lamure" without rel="noopener noreferrer" target="_blank" className="relative mx-auto lg:hidden">
        ...
        <a href={CvPdf} without rel="noopener noreferrer" target="_blank" className="relative mx-auto mt-[3rem] mb-8">
